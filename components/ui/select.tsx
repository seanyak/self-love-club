...
SelectTrigger.displayName = 'SelectTrigger'; // Add display name for better debugging
...
SelectContent.displayName = 'SelectContent'; // Add display name for better debugging
...
SelectLabel.displayName = 'SelectLabel'; // Add display name for better debugging
...
SelectItem.displayName = 'SelectItem'; // Add display name for better debugging
...
SelectGroup.displayName = 'SelectGroup'; // Add display name for better debugging
...
SelectSeparator.displayName = 'SelectSeparator'; // Add display name for better debugging
