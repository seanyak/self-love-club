...
function Topbar() {
    ...
    return (
        <nav className="topbar dark:bg-[#3e4c66] flex flex-col sm:flex-row justify-between items-center px-2 py-1 bg-opacity-90 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem]">
