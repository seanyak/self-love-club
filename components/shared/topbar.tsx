...
function Topbar() {
    ...
    return (
        <nav className="topbar dark:bg-[#39404c] flex flex-col sm:flex-row justify-between items-center px-3 py-1 bg-opacity-90 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem]">
